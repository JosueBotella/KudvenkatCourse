...
export class employeeListComponent{
    ...
    constructor(){
        this.employees= [
            { code: 'emp101', name: 'Tom', gender: 'Male', annualSalary: 5500, dateOfBirth: '9/6/1982' },
            ...
            { code: 'emp104', name: 'Mary', gender: 'Female', annualSalary: 6500.826, dateOfBirth: '9/6/1982' },
            { code: 'emp105', name: 'John', gender: 'Male', annualSalary: 32500.826, dateOfBirth: '11/03/2005' },
            { code: 'emp106', name: 'Lina', gender: 'Female', annualSalary: 61500.826, dateOfBirth: '03/10/1980' },
            { code: 'emp107', name: 'Pepe', gender: 'Male', annualSalary: 72500.826, dateOfBirth: '2/06/2005' },
            { code: 'emp108', name: 'Morgan', gender: 'Female', annualSalary: 43500.826, dateOfBirth: '03/10/1980' },
        ];
    }
    ...
    /* getEmployeeList(): void{
        this.employees = [
            ...
            { code: 'emp103', name: 'Mike', gender: 'Male', annualSalary: 5900, dateOfBirth: '12/8/1979' },
            { code: 'emp104', name: 'Mary', gender: 'Female', annualSalary: 6500.826, dateOfBirth: '9/6/1982' },
            { code: 'emp105', name: 'John', gender: 'Male', annualSalary: 32500.826, dateOfBirth: '11/11/2005' },
            { code: 'emp106', name: 'Lina', gender: 'Female', annualSalary: 61500.826, dateOfBirth: '03/10/1980' },
        ];
    } */
